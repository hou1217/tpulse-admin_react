...
const router = [

	{
		name: '首页',
		path: '/',
		component: () => import( /* webpackChunkName: "home" */ '@/views/index/Home'),
  ...
  //single router
  {
    path: '/loginPhone',
    name: 'loginPhone',
    component: () => import( /* webpackChunkName: "loginPhone" */ '@/views/login'),
    single: true,
		hideInMenu: true
  },
	// {
  ...
  // },
	//404单独处理
	{
		name: '404',
		path: '/404',
		component: () => import( /* webpackChunkName: "home" */ '@/views/Others/404'),
		single: true,
		hideInMenu: true
	}
];
